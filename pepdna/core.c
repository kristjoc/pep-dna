...
/* MODULE_PARM_DESC(ip, "PEP-DNA listening IP address"); */
...
MODULE_PARM_DESC(pepdna_mode, "TCP2RINA | RINA2TCP | TCP2TCP | RINA2RINA");
...
static const char* get_mode_name(void)
{
    switch (pepdna_mode) {
        ...
        case 2:  return "RINA2TCP";
        case 3:  return "RINA2RINA";
...
/* module metadata */
MODULE_LICENSE("GPL");
MODULE_AUTHOR("kr1stj0n");
MODULE_VERSION(PEPDNA_MOD_VER);
MODULE_DESCRIPTION("PEPDNA kernel module");
